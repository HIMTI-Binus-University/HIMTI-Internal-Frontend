...
>(({ className, ...props }, ref) => {
  const overlayRef = React.useRef<React.ElementRef<typeof DialogPrimitive.Overlay>>(null)
  React.useImperativeHandle(ref, () => overlayRef.current as React.ElementRef<typeof DialogPrimitive.Overlay>)
  useGSAP(() => {
...
>(({ className, children, ...props }, ref) => {
  ...
  React.useImperativeHandle(ref, () => contentRef.current as React.ElementRef<typeof DialogPrimitive.Content>)
  useGSAP(() => {
    const media = gsap.matchMedia()
    media.add("(prefers-reduced-motion: no-preference)", () => {
