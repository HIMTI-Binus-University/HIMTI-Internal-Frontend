...
export const Api = {
  ...
  elections: `${API_URL}/api/internal/elections`,
  election: `${API_URL}/api/internal/elections/:electionId`,
  electionCandidates: `${API_URL}/api/internal/elections/:electionId/candidates`,
  electionCandidate: `${API_URL}/api/internal/elections/candidates/:candidateId`,
  electionOpen: `${API_URL}/api/internal/elections/:electionId/open`,
  electionClose: `${API_URL}/api/internal/elections/:electionId/close`,
  electionPublish: `${API_URL}/api/internal/elections/:electionId/publish`,
  electionDebateSchedule: `${API_URL}/api/internal/elections/:electionId/debate-schedule`,
  electionPublicDetails: `${API_URL}/api/internal/elections/:electionId/public-details`,
  electionTurnout: `${API_URL}/api/internal/elections/:electionId/turnout`,
  electionTally: `${API_URL}/api/internal/elections/:electionId/tally`,
};
