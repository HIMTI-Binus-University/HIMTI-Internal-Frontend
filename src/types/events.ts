...
export type SubeventStatus = "DRAFT" | "PUBLISHED" | "CLOSED" | "CANCELLED" | "ARCHIVED";
...
export interface Event { id: string; name: string; publicDescription?: string; requirements?: string; coverImageUrl?: string; status: EventStatus; createdAt: string; createdBy: string; updatedAt?: string; updatedBy?: string; }
