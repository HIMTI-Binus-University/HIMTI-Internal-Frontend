...
export const StatCard = ({
  ...
  <Card
    className={cn(
      tone === "warning" && "border-semantic-warning-border",
      tone === "danger" && "border-semantic-danger-border",
      tone === "success" && "border-semantic-success-border",
    )}
  >
  ...
  <div className="overflow-hidden rounded-xl border border-border bg-card">
    ...
    <div className="p-4 sm:p-5">
      {backTo && (
        <Link
          to={backTo}
          className="mb-3 inline-flex min-h-11 items-center gap-2 rounded-lg px-1 text-sm font-medium text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
...
export const SetupStepper = ({
  ...
  const labels = ["Details", "Registration", "Payment", "Review"];
  return (
    <ol className="grid grid-cols-4 gap-2" aria-label="Subevent setup progress">
...
export const Warning = ({ children }: { children: React.ReactNode }) => (
  <div className="flex gap-3 rounded-lg border border-semantic-warning-border bg-semantic-warning-background p-3 text-sm leading-6 text-semantic-warning">
